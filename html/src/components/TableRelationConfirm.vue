<template>
  <div class="relation-confirm">
    ...
    <el-table :data="relations" border size="small" max-height="300">
    ...
    <div v-if="confirmedRelations.length > 0" class="confirmed-info">
      <el-tag type="success">
        已确认 {{ confirmedRelations.length }} 条关系
      </el-tag>
    </div>
  </div>
</template>
...
function handleConfirm() {
  confirmedRelations.value = localRelations.value
